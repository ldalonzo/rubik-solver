...
public class TurnClockwiseUnitTest
{
    ...
    public void White()
    {
        var actual = Cube.WhiteClockwise();
    ...
    public void Yellow()
    {
        var actual = Cube.YellowClockwise();
        actual.Should().NotBeSameAs(Cube);
    ...
    public void Orange()
    {
        var actual = Cube.OrangeClockwise();
        actual.Should().NotBeSameAs(Cube);
    ...
    public void Green()
    {
        var actual = Cube.GreenClockwise();
        actual.Should().NotBeSameAs(Cube);
