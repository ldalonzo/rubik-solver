...
public class TurnClockwiseOrthoUnitTest
{
    ...
    {
        var actual = Cube
            .Turn(new Move(MoveKind.White, true))
            .Turn(new Move(MoveKind.Green, true));
        ...
        actual.Green.C21.Should().Be(FaceColor.Red);
    ...
    public void WhiteRed()
    {
        var actual = Cube
            .Turn(new Move(MoveKind.White, true))
            .Turn(new Move(MoveKind.Red, true));
        actual.Should().NotBeSameAs(Cube);
    ...
    public void WhiteBlue()
    {
        var actual = Cube
            .Turn(new Move(MoveKind.White, true))
            .Turn(new Move(MoveKind.Blue, true));
        actual.Should().NotBeSameAs(Cube);
    ...
    public void WhiteOrange()
    {
        var actual = Cube
            .Turn(new Move(MoveKind.White, true))
            .Turn(new Move(MoveKind.Orange, true));
        actual.Should().NotBeSameAs(Cube);
    ...
    {
        var actual = Cube
            .Turn(new Move(MoveKind.Yellow, true))
            .Turn(new Move(MoveKind.Blue, true));
        actual.Should().NotBeSameAs(Cube);
    ...
    public void YellowGreen()
    {
        ...
        actual.Green.C21.Should().Be(FaceColor.Green);
        actual.Green.C22.Should().Be(FaceColor.Green);
        actual.Green.C23.Should().Be(FaceColor.Orange);
        actual.Green.C31.Should().Be(FaceColor.Green);
        actual.Green.C32.Should().Be(FaceColor.Green);
